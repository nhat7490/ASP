...
class RoomDetailVC:BaseVC,UIScrollViewDelegate,OptionViewDelegate{
    ...
    func setupUI() {
        ...
        let utilitiesViewHeight =  Constants.HEIGHT_CELL_NEW_UTILITYCV * Double(numberOfRow) + 40.0
        let totalContentViewHeight = CGFloat(715 + membersViewHeight + utilitiesViewHeight+Constants.HEIGHT_LARGE_SPACE)
